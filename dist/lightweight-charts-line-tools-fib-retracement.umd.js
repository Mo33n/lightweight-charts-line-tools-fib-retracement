(function (global, factory) {
    ...
    class LineToolFibRetracementPaneView extends lightweightChartsLineToolsCore.LineToolPaneView {
        ...
        _updateImpl(height, width) {
            ...
            for (let i = 0; i < levelsConfig.length; i++) {
                ...
                const P_TextLeftAnchor = new lightweightChartsLineToolsCore.AnchorPoint(0, levelCoord, i);
                const P_TextRightAnchor = new lightweightChartsLineToolsCore.AnchorPoint(minScreenX, levelCoord, i);
    ...
    class LineToolFibRetracement extends lightweightChartsLineToolsCore.BaseLineTool {
        ...
        updateCullingState() {
            ...
            const cullingState = lightweightChartsLineToolsCore.getToolCullingState(zonePoints, this, options.extend, undefined, undefined, true // isAreaBased: true
            );
